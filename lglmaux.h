...
LUAI_FUNC int luaglm_ivec (lua_State *L);
LUAI_FUNC int luaglm_ivec2 (lua_State *L);
LUAI_FUNC int luaglm_ivec3 (lua_State *L);
LUAI_FUNC int luaglm_ivec4 (lua_State *L);
LUAI_FUNC int luaglm_bvec (lua_State *L);
LUAI_FUNC int luaglm_bvec2 (lua_State *L);
LUAI_FUNC int luaglm_bvec3 (lua_State *L);
LUAI_FUNC int luaglm_bvec4 (lua_State *L);
