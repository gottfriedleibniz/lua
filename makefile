...
lvm.o: lvm.c lprefix.h lua.h luaconf.h lauxlib.h ldebug.h lstate.h \
 lobject.h llimits.h ltm.h lzio.h lmem.h ldo.h lfunc.h lgc.h lopcodes.h \
...
onelua.o: onelua.c lprefix.h luaconf.h lzio.c lua.h llimits.h lmem.h \
 ...
 ldump.c lstate.c lapi.h llex.h ltable.h lgc.c ldebug.c lcode.h lparser.h \
 lvm.h lfunc.c lobject.c ltm.c lstring.c ltable.c ldo.c lvm.c \
 lauxlib.h lapi.c llex.c lcode.c lparser.c \
 lauxlib.c lbaselib.c lualib.h lcorolib.c ldblib.c liolib.c lmathlib.c \
 loadlib.c loslib.c lstrlib.c ltablib.c lutf8lib.c linit.c lua.c
	$(CC) $(CFLAGS) -DLUA_PLATFORM=\"$(UNAME)\" -c -o $@ onelua.c
