...
*/
  ...
  #define LUA_MINSIZE __attribute__((minsize))
#elif LUA_HAS_ATTRIBUTE(__optimize__)
  #define LUA_MINSIZE __attribute__((__optimize__("Os")))
#else
  #define LUA_MINSIZE
#endif
...
#define LUA_EXT_LITERAL

/* Indexing operation that suppresses errors on accesses into undefined table */
#define LUA_EXT_SAFENAV

/* Syntactic sugar to improve the syntax for specifying sets */
#define LUA_EXT_SETINIT

/* VM */

/* Expand the size of type and variant bits; uses TValue padding bytes to align
** with char (and register) boundaries. */
#if LUAI_IS32INT
...
/* Expose lua_createtable and other WowLua compatibility functions */
#define LUA_EXT_API

/* Enable nanosecond resolution timers and x86 rdtsc sampling */
...
/* Enable readonly table API */
#define LUA_EXT_READONLY

/* Tagged userdata */
#define LUA_EXT_USERTAG
